console.info('contentScript is running');
  ...
  (function() {
    ...
    function injectChatInterface() {
      ...
      const targetElement = document.querySelector('ytd-watch-next-secondary-results-renderer') as HTMLElement || document.querySelector('ytd-comments') as HTMLElement || document.querySelector('ytd-video-primary-info-renderer') as HTMLElement || document.querySelector('ytd-video-secondary') as HTMLElement;
    ...
    function handleSendMessage() {
      ...
      const userInput = document.getElementById('yt-user-input') as HTMLInputElement;
    ...
    function addMessageToChat(sender: string, message:string) {
      const chatMessages = document.getElementById('yt-chat-messages') as HTMLDivElement;
    ...
    function sendMessageToLLM(message: string) {
